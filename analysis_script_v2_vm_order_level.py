        ...
        for var in num_variants: # Loop through all variants
            for exp in exp_length: # Loop through all experiment lengths
                ...
                var_allocation_func(
                    ...
                    input_file_name="input_v2_order_level.csv"
                ...
                for iter_col in kpi_col_list: # Pick the columns from the data frame that has more columns
...
df_pval.to_excel("df_pval_v2_order_level.xlsx", index=False)
