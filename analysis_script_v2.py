...
pval_list_tot = []
pval_list_per_order = []
for zn in zone_groups[0:2]: # Loop through all the zone group IDs
    for sb in sb_window_size[0:2]: # Loop through all switchback window sizes
        for var in num_variants[0:2]: # Loop through all variants
            for exp in exp_length[0:2]: # Loop through all experiment lengths
